...
public static partial class MathExt
{
  ...
  [MethodImpl(MethodImplOptions.AggressiveInlining)] public static float2 normalize_safe(this float2 v) => math.normalizesafe(v);
  [MethodImpl(MethodImplOptions.AggressiveInlining)] public static float3 normalize_safe(this float3 v) => math.normalizesafe(v);
