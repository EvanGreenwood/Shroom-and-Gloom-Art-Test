...
public struct FloatAnim
{
  ...
  public FloatAnim(EasingType easing, LoopType loopType, float duration, bool reverse)
  {
    _easing = easing;
    _loopType = loopType;
  ...
  public FloatAnim(EasingType easing, LoopType loopType, float duration) : this(easing, loopType, duration, false) { }
  public FloatAnim(EasingType easing, float duration, bool reverse) : this(easing, LoopType.None, duration, reverse) { }
  public FloatAnim(EasingType easing, float duration) : this(easing, LoopType.None, duration, false) { }
  ...
  public void Step(float deltaTime)
  {
    ...
    _value = Easing.Ease(Mathf.Clamp01(_percent), _easing);
  }
