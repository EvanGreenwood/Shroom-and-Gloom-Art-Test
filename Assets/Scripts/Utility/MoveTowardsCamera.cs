...
public class MoveTowardsCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.position = Vector3.Lerp(transform.position, _startPos, UnityEngine.Time.deltaTime * 2f);
            return;
        }
        ...
        transform.position = Vector3.Lerp(transform.position, nextPos, UnityEngine.Time.deltaTime);
    }
}
